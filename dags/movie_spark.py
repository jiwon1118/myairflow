...
with DAG(
    ...
    SCRIPT_BASE="/home/jiwon/code/myairflow/pyspark"
    META_PATH="/home/jiwon/data/movie_spark/meta"
    RAW_BASE="/home/jiwon/data/movie_after/dailyboxoffice"
    ...
    exist_meta = BranchPythonOperator(
        task_id="exist.meta",
    ...
    start >> exist_meta >> [create_meta, append_meta] >> end